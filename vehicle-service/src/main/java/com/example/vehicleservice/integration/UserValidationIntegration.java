...
import com.example.vehicleservice.kafka.consumer.UserConsumer;
import com.example.vehicleservice.kafka.producer.UserProducer;
...
public class UserValidationIntegration {
    ...
    public CompletableFuture<UserValidationResponse> validateUser(String userId, String email) {
        ...
        try {
            ...
            UserValidationRequest request = new UserValidationRequest(userId,email );
